...
import { getMascotImagePath, useUserMascotState } from "./mascot";
...
export const AppHeader: React.FC = () => {
  ...
  const { mascotId, isLoading: isMascotLoading } = useUserMascotState();
        ...
        <Toolbar disableGutters sx={{ minHeight: { xs: 64, md: 78 }, gap: { xs: 1.5, md: 3 } }}>
          ...
          >
            ...
            <Box sx={{ display: { xs: "none", sm: "block" }, lineHeight: 1 }}>
              ...
              <Typography component="div" sx={{ mt: 0.4, fontSize: { sm: 13, md: 16 }, fontWeight: 700 }}>
                Engineer Quest
              </Typography>
            </Box>
          </Box>
